...
export const ProductCard: React.FC<IProductCard> = (props) => {
    ...
    return (
        <div className={`product flex flex-col px-4 py-2 w-full md:w-full md:flex-row md:space-x-2 md:items-start md:p-4 border-l-[#fff] border border-gray-ghost even:border-r-[#fff] sm:even:border-r-gray-ghost  md:border-t-[#fff]`}>
